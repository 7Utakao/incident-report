...
const inputClasses = computed(() => {
  const baseClasses =
    'block w-full rounded-md py-1.5 shadow-sm sm:text-sm sm:leading-6 transition-colors disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-500 dark:disabled:bg-gray-800 dark:disabled:text-gray-400';
